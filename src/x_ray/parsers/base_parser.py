"""Shared table/chart/code renderer for analysis result parsers.

This module is the generic rendering base used by the healthcheck, gmd and
ftdc parsers. Each analysis module subclasses :class:`BaseParser` and sets its
own ``TEMPLATE_FOLDER`` (the directory holding the frontend chart snippets).
"""
